  ...
  <body>    
    ...
    color: initial;
     margin-top: -100px;">
            ...
            <p style="color: darkorange;">Are you suffering from chest pain</p>
            <img class="img-center" src="images/chestpain.png">
            <input type="radio"  name="radio" value=""  style="color: red" /><a href="heartattack_chestpain1.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" />  <a href="#"> NO </a>
          </div>
      <div class="container">
        <%
