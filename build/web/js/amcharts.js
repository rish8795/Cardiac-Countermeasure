...
(function() {
    ...
    d.AxisBase = d.Class({construct: function(a) {
            ...
            var u, x = this.gridAlpha, y, w = this.choosePeriod(0), A = w.period, w = w.count, z = d.getPeriodDuration(A, w);
            z < k && (A = g.period, w = g.count, z = k);
            g = A;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / z) + 5, C = l = d.resetDateToMin(new Date(this.startTime - z), A, w, t).getTime();
            if (g == A && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels)
            ...
            q = this.firstTime;
            var D = 0, L = 0;
            a && 1 < w && (u = this.chooseMinorFrequency(w), y = d.getPeriodDuration(A, u), "DD" == A && (y += d.getPeriodDuration("hh")));
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    "DD" == A && (p += 36E5);
                    p = d.resetDateToMin(new Date(p), A, w, t).getTime();
                    ...
                    if ("radar" == b.type) {
                        ...
                        this.rotate ? "date" == this.type && "middle" == this.gridPosition &&
                    ...
                    if (a == k && !c || a == B && !e)
                        f = " ";
                    this.labelFunction && (f = this.labelFunction(f, new Date(p), this, A, w, m).toString());
                    this.boldLabels && (l = !0);
                    ...
                    if (!isNaN(u))
                        for (h = 1; h < w; h += u)
                            this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), A, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                    this.gridAlpha = x
                }
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                if (this.logarithmic) {
                    ...
                    this.relativeStart = (Math.log(this.minReal) / Math.LN10 -
                            Math.log(this.fullMin) * Math.LOG10E) / g;
                ...
                !0 === h ? (u = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / u, u > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, t = Math.round(Math.log(this.minReal) *
                        Math.LOG10E), r > this.gridCountR && (p = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                var x = 0;
                ...
                var x = this.step, A, w = this.minorGridAlpha;
                this.minorGridEnabled && (A = this.getMinorGridStep(x, this.stepWidth * x));
                        ...
                        for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), h && r++, g = t; g < r; g += p)
                            if (c = x * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                                if (isNaN(y) || Number(d.toFixed(c, y)) == c) {
                                    ...
                                    var z;
                                    this.rotate && this.autoWrap && (z = this.stepWidth * x - 10);
                                    ...
                                    if (!isNaN(A) && 0 < w && g < r - 1) {
                                        t = x / A;
                                        h && (A = x * (g + p) + this.minCalc, A = d.roundTo(A, this.maxDecCount + 1), u > this.logGridLimit && (A = Math.pow(10, g + p)), t = 10, A = (A - c) / t);
                                        f = this.gridAlpha;
                                        this.gridAlpha = this.minorGridAlpha;
                                        for (D = 1; D < t; D++) {
                                            var L = this.getCoordinate(c + A * D), L = new this.axisItemRenderer(this, L, "", !1, 0, 0, !1, !1, 0, !0);
                                            this.pushAxisItem(L)
                                        }
                                        this.gridAlpha = f
                                    }
                ...
                if (0 < z) {
                    B =
                            this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < z; g++)
                        C = u[g], k = NaN, A = C.above, isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), t = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(t, A)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(C.value), t = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(t, A)), isNaN(k) && (l -= 3, k = l + 3), isNaN(k - l) || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, A), A = k.graphics(), C.graphics = A, C.balloonText && this.addEventListeners(A,
                                C));
                    this.fillAlpha = B
                }
                g = this.baseValue;
...
(function() {
    ...
    d.RecItem = d.Class({construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            this.set = y;
            var w = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, C = a.gridAlpha, D = a.gridThickness, L = a.gridColor, I = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
            n = a.labelRotationR;
    ...
    d.AmGraph = d.Class({construct: function(a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))
                    ...
                    n.y = t;
                    if (x = this.labelText)
                        x = this.createLabel(n, x), u = 0, r && (u = r.size), this.positionLabel(n, q, t, x, u);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), x = this.connect, y = [], w = [], A, z, B, C, D = this.chart.graphs.length, L, I = this.dx / this.tcc, S = this.dy /
            ...
            T > Ca && (T = Ca);
            var G, v, na, ha = q, Pa = n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors, Ja = this.negativeLineColor,
            ...
            for (K = Q; K <= ia; K++) {
                ...
                if (m && void 0 == this.openField)
                    for (var yb = K + 1; yb < e.length && (!e[yb] || !(ab = e[K + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value, isNaN(Ta))); yb++)
                        ;
                var R, P, J, aa, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Da = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ha = ya, Aa, Ea, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                ...
                if (Ia) {
                    ...
                    if (!Bb && W < ta || Bb && W < za)
                        v.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    ...
                    switch (g) {
                        case"line":
                            if (isNaN(W))
                                x || (this.drawLineGraph(y, w, U, V), y = [], w = [], U = [], V = []);
                            else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb)
                                    y.push(E), w.push(F), jb = E, kb = F;
                                wa = E;
                                Da = F;
                                ka = E;
                                la = F;
                                ...
                                if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(v.dashLength))
                                    this.drawLineGraph(y, w, U, V), y = [E], w = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M)), m ? Sa ? (this.lineColorSwitched = ya, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
                                v.gap && (this.drawLineGraph(y, w, U, V), y = [], w = [], U = [], V = [])
                            }
                            break;
                        case"smoothedLine":
                            if (isNaN(W))
                                x || (this.drawSmoothedGraph(y, w, U, V), y = [], w = [], U = [], V = []);
                            else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb)
                                    y.push(E), w.push(F), jb = E, kb = F;
                                wa = E;
                        ...
                        case"step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (y.push(A), w.push(F - xa)), w.push(F - xa), y.push(E), w.push(F + Ga), y.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M -
                                        xa)), U.push(N), V.push(M - xa), U.push(N), V.push(M + Ga))) : (isNaN(z) || (w.push(z), y.push(E - xa)), y.push(E - xa), w.push(F), y.push(E + Ga), w.push(F), !Ra || isNaN(M) || isNaN(N) || (isNaN(C) || (U.push(N - xa), V.push(C)), U.push(N - xa), V.push(M), U.push(N + Ga), V.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                C = M;
                                ...
                                if ($a || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                                    var cc = y[y.length - 2], dc = w[w.length - 2];
                                    y.pop();
                                    w.pop();
                                ...
                                if (Nb || v.gap)
                                    A = z = NaN, this.drawLineGraph(y, w, U, V), y = [], w = [], U = [], V = []
                            } else if (!x) {
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)
                "smoothedLine" == g ? this.drawSmoothedGraph(y, w, U, V) : this.drawLineGraph(y, w, U, V), H || this.launchAnimation();
            ...
            if (1 < a.length) {
                ...
                var x = h.negativeLineColor, w = h.negativeFillColors, A = h.negativeFillAlphas, z = h.baseCoord;
                ...
                if (0 < g || 0 < A)
                    if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == q ? (r.push(0), p.push(0)) : h.rotate ? (r.push(r[r.length - 1]), p.push(z), r.push(r[0]), p.push(z), r.push(r[0]), p.push(p[0])) : (p.push(p[p.length - 1]), r.push(z), p.push(p[0]), r.push(z), p.push(a[0]), r.push(r[0])) : "xy" == q && (b = h.fillToAxis) && (d.isString(b) && (b = k.getValueAxisById(b)), "H" == b.orientation ? (z = "top" == b.position ? 0 : b.height, p.push(p[p.length - 1]), r.push(z), p.push(p[0]), r.push(z), p.push(a[0]), r.push(r[0])) : (z = "left" == b.position ? 0 : b.width, r.push(r[r.length - 1]), p.push(z), r.push(r[0]), p.push(z), r.push(r[0]), p.push(p[0]))), a = h.gradientRotation, 0 < g && (b = d.polygon(l, p, r, u, g, 1, "#000", 0, a, f), b.pattern(h.pattern, NaN, k.path), d.setCN(k, b, h.bcn + "fill"), m.push(b)), w || void 0 !== x)
                        isNaN(A) && (A = g), w || (w = x), f = d.polygon(l, p, r, w, A, 1, "#000", 0, a, f), d.setCN(k, f, h.bcn + "fill"), d.setCN(k, f, h.bcn + "fill-negative"), f.pattern(h.pattern, NaN, k.path), n.push(f), n.click(function(a) {
                            h.handleGraphEvent(a, "clickGraph")
                        }).mouseover(function(a) {
                            h.handleGraphEvent(a, "rollOverGraph")
                        }).mouseout(function(a) {
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, x = this.negativeFillAlphas, y = this.baseCoord, w = this.lineColorSwitched;
                w && (p = w);
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1], n += " L" + y + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + y, n += " L" + a[0] + "," + y), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== r) && (x || (x = q), u || (u = r), a = new d.Bezier(g, a, b, NaN, 0, 0, u, x, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({opacity: 1, translate: e + "," +
                d}, f, g), c.animate({opacity: 1, translate: e + "," + d}, f, g), a.animatable.push(b))
        }, animate: function(a) {
...
(function() {
    ...
    d.ChartCursor = d.Class({construct: function(a) {
            ...
            this.forceShow = !1;
            this.chart.wasTouched && this.leaveAfterTouch || this.isHidden || this.leaveCursor || (this.hideLines(), this.isHidden = !0, this.index = this.prevLineY = this.prevLineX = this.mouseY0 = this.mouseX0 = this.fy = this.fx = NaN, a ? this.chart.handleCursorHide() : this.fire({target: this, chart: this.chart, type: "onHideCursor"}), this.chart.setMouseCursor("auto"))
        }, hideLines: function() {
            ...
            this.drawing || (this.vLineEnabled && this.vvLine && this.vvLine.show(), this.hLineEnabled && this.hhLine && this.hhLine.show(), this.isHidden = !1, this.updateFullLine(), a || this.fire({target: this, chart: this.chart, type: "onShowCursor"}), this.pan && this.chart.setMouseCursor("move"))
            ...
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width,
                ...
                h && (this.hideLines(), this.fire({type: "panning", chart: this.chart, target: this, deltaX: a, deltaY: b, delta2X: c, delta2Y: e, index: this.index}), this.prevDeltaX = a, this.prevDeltaY = b, this.prevDelta2X = c, this.prevDelta2Y = e)
            }
...
(function() {
    ...
    d.SimpleChartScrollbar = d.Class({construct: function(a) {
            ...
            if (k) {
                ...
                if (n.mouseIsOver && (this.dragging && (n = this.initialCoord, m ? (a = n + (r - a), 0 > a && (a = 0), n = p - k, a > n && (a = n), g.setAttr("y", a)) : (a = n + (t - a), 0 > a && (a = 0), n = q - l, a > n && (a = n), g.setAttr("x", a)), this.clipDragger(!0)), this.resizingRight && (m ? (a = r - e, a + e > p + f && (a = p - e + f), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = .1), g.setAttr("height", a))) : (a = t - c, a + c > q + d && (a = q - c + d), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = .1), g.setAttr("width", a))), this.clipDragger(!0)), this.resizingLeft)) {
                    if (m)
                        if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p +
                                f && (e = p + f), a = !0 === b ? c - e : k + c - e, 0 > a)
            ...
            if (this.skipEvent)
                ...
                this.fire({type: "zoomed", position: b, chart: a, target: this, multiplier: g, relativeStart: c, relativeEnd: k})
            }
        }, updateDragIconPositions: function() {
            var a = this.getDBox(), b = a.x, c = a.y, e = this.iconLeft,
                    d = this.iconRight, f, g, k = this.scrollbarHeight;
            ...
            if ("ValueAxis" == this.categoryAxis.cname)
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = g.lastTime, g = g.firstTime, k = Math.round(b / l) + g, b = this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + g, k > b && (k = b), 0 < h && b - k < h && (b = Math.round(k + (b - k) / 2), m = Math.round(h / 2), k = b - m, b += m, m = !0), 0 < e && b - k > e && (b = Math.round(k + (b - k) / 2), m = Math.round(e / 2), k = b - m, b += m, m = !0), b > a && (b = a), b - h < k && (k = b - h), k < g && (k = g), k + h > b && (b = k + h), k != this.startTime || b != this.endTime)
                        ...
                        (b += l / 2), c -= this.stepWidth / 2, h = k.xToIndex(b), b = k.xToIndex(b + c), h != this.start || this.end != b)
    ...
    d.AmBalloon = d.Class({construct: function(a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth, y = this.pointerOrientation, w = this.cornerRadius, A = c.fontFamily, z = this.fontSize;
                    ...
                    "H" != y ? (C = a - D / 2, b < k + A + 10 && "down" != y ? (S = !0, e && (b += z), z = b + x, this.deltaSignY = -1) : (e && (b -= z), z = b - A - x, this.deltaSignY = 1)) : (2 * x > A && (x = A / 2), z = b - A / 2, a < g + (l - g) / 2 ? (C = a + x, this.deltaSignX = -1) : (C = a - D - x, this.deltaSignX = 1));
                    z + A >= m && (z = m - A);
                    z < k && (z = k);
                    C < g && (C = g);
                    C + D > l && (C = l - D);
                    var k = z + u, m = C + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, H, u = this.fillAlpha, Z = this.borderAlpha;
                    this.showBullet && (H = d.circle(h, ia, t, u), f.push(H));
                    this.drop ? (g = D / 1.6, l = 0, "V" == y && (y = "down"), "H" == y && (y = "left"), "down" == y && (C = a + 1, z = b - g - g / 3), "up" == y && (l = 180, C = a + 1, z = b + g + g / 3), "left" == y && (l = 270, C = a + g + g / 3 + 2, z = b), "right" == y && (l = 90, C = a - g - g / 3 + 2, z = b), k = z - I / 2 + 1, m = C - L / 2 - 1, q = d.drop(h, g, l, q, u, r, p, Z)) : 0 < w || 0 === x ? (0 < O && (a = d.rect(h, D, A, q, 0, r + 1, Q, O, w), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, D, A, q, u, r, p, Z, w)) : (t = [], w = [], "H" != y ? (g = a - C, g > D - x && (g = D - x), g < x && (g = x), t = [0, g - x, a - C, g + x, D, D, 0, 0], w = S ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (y = b - z, y > A - x && (y = A - x), y < x && (y = x), w = [0, y - x, b - z, y + x, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, C < a ? 0 : a - C, 0, 0, D, D, 0] : [D, D, C + D > a ? D : a - C, D, D, 0, 0, D]), 0 < O && (a = d.polygon(h, t, w, q, 0, r, Q, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, w, q, u, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
...
(function() {
    ...
    d.AmCoordinateChart = d.Class({inherits: d.AmChart, construct: function(a) {
            ...
            for (w = b; w < c; w++) {
                ...
                q && (B.labelColor = C[q]);
                y[C[g]] = B;
                if (k && (m.categoryFunction ? b = m.categoryFunction(b, C, m) : (!A || b instanceof Date || (b = b.toString() + " |"), b = d.getDate(b, A, m.minPeriod)), b = d.resetDateToMin(b, r, t, m.firstDayOfWeek), B.category = b, B.time = b.getTime(), isNaN(B.time)))
                    continue;
                ...
                for (L = 0; L < D.length; L++) {
                    ...
                    for (S = 0; S < h.length; S++) {
                        ...
                        if (b.valueAxis.id == I) {
                            ...
                            !b.connect && z && z[O] && 0 < Q && B.time - u[O] >= x * Q && (z[O].gap = !0);
...
(function() {
    ...
    d.TrendLine = d.Class({construct: function(a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, u = a.finalXValue, x = a.initialValue, y = a.finalValue, w = p.recalculateToPercents, A = b.dataDateFormat;
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        359.94 < y && (y = 359.94);
        h >= y && (h = y);
        var w = 1 / 180 * Math.PI, y = b + Math.sin(e * w) * k, A = c - Math.cos(e * w) * u, z = b + Math.sin(e * w) * f, B = c - Math.cos(e * w) * g, C = b + Math.sin((e + h) * w) * f, D = c - Math.cos((e + h) * w) * g, L = b + Math.sin((e + h) * w) * k, w = c - Math.cos((e + h) * w) * u, I = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, S = 0;
        180 < Math.abs(h) && (S = 1);
        e = a.set();
        var O;
        x && (y = r(10 * y), z = r(10 * z), C = r(10 * C), L = r(10 * L), A = r(10 * A), B = r(10 * B), D = r(10 * D), w = r(10 * w), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, u *= 10, 1 > Math.abs(h) && 1 >= Math.abs(C - z) && 1 >= Math.abs(D - B) && (O = !0));
        h = "";
        var Q;
        q && (I["fill-opacity"] = 0, I["stroke-opacity"] = m["stroke-opacity"] / 2, I.stroke = m.stroke);
        if (0 < l) {
            Q = " M" + y + "," + (A + l) + " L" + z + "," + (B + l);
            x ? (O || (Q += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + C + "," + (D + l)), Q += " L" + L + "," + (w + l), 0 < k && (O || (Q += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," +
                    (l + c + u) + "," + L + "," + (l + w) + "," + y + "," + (l + A)))) : (Q += " A" + f + "," + g + ",0," + S + ",1," + C + "," + (D + l) + " L" + L + "," + (w + l), 0 < k && (Q += " A" + k + "," + u + ",0," + S + ",0," + y + "," + (A + l)));
            Q += " Z";
            var ia = l;
            x && (ia /= 10);
        ...
        x ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(B) + "," + r(C) + "," + r(D)), g = " M" + r(y) + "," + r(A) + " L" + r(z) + "," + r(B) + h + " L" + r(L) + "," + r(w)) : g = " M" + y + "," + A + " L" + z + "," + B + (" A" + f + "," + g + ",0," + S + ",1," + C + "," + D) + " L" + L + "," + w;
        0 < k && (x ? O || (g += " B" + (b - k) + "," + (c - u) + "," + (b + k) + "," + (c + u) + "," + L + "," + w + "," + y + "," + A) : g += " A" + k + "," + u + ",0," + S + ",0," + y + "," + A);
...
(function() {
    ...
    d.AmLegend = d.Class({construct: function(a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
            this.set && this.set.remove();
            var u = r.set();
            this.set = u;
            var x = r.set();
            u.push(x);
            var y = this.entries, w, A;
            ...
            for (A = 0; A < y.length; A++) {
                ...
                w = L.getBBox();
                var I;
                this.equalWidths ? I = z * (p + n + this.markerLabelGap) : (I = B, B = B + w.width + f + n);
                w.height > D && (D = w.height);
                I + w.width > q && 0 < A && 0 !== z && (t++, I = z = 0, B = I + w.width + f + n, C = C + D + m, D = 0);
                L.translate(I, C);
                z++;
            ...
            var a = (this.markerSize - 4) / 2, b = {stroke: this.switchColor,
                "stroke-width": 3}, c = this.container, e = d.line(c, [-a, a], [-a, a]).attr(b), a = d.line(c, [-a, a], [a, -a]).attr(b);
