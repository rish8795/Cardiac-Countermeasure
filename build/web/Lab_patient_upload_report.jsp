<%-- 
    Document   : Lab_patient_upload_report
    Created on : 19 Apr, 2016, 2:55:46 PM
    Author     : Dell
--%>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Cardiac Countermeasure: Upload Report</title>
          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              <div class="patient_profile">
               ...
               <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-envelope"></i><span>Upload Report</span></button>
               <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-envelope"></i><span>Cancel Appointment</span></button>
               </form>
               </div> 
