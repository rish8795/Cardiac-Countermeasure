<%-- 
    Document   : patient_view_doctorappointment
    Created on : 22 Apr, 2016, 5:57:35 PM
    Author     : Dell
--%>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Cardiac Countermeasure:Doctor Appointment</title>
            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  ...
                  <li class="active">My Doctor Appointments</li>
                </ol>
              </div>
            </div>
          </div>
                        ...
                        <!-- Start sidebar widget -->
                             ...
                             <table class="table table-hover">
                                ...
                                <tbody>
                                     ...
                                     <%
                        ArrayList<DoctorAppointment> la = (ArrayList<DoctorAppointment>) request.getAttribute("la");
                        ArrayList<DoctorAppointment> docarray = (ArrayList<DoctorAppointment>) request.getAttribute("ptest");
//                        System.out.println(la);
                        int loop=1;
                        for (int i = 0; i < la.size(); i++) {

                          //  DoctorAppointment test1 = docarray.get(i);
                            DoctorAppointment l = la.get(i);
                            String dt = "---";
                            String tm = "---";
                    ...
                    %>
                                  ...
                                  <tr>
                                    ...
                                    <td> Dr.<%=  l.getDId().getDFirstname()+ "" +l.getDId().getDLastname() %></td>
                                  <td><%=dt%></td>
                                  <td><%=tm%></td>
