...
<html lang="en">
  ...
  <body>    
    ...
    margin-top: -100px;">
            ...
            <p style="color: darkorange;">Do you have Cholestrol?</p>
            <img class="img-center" src="images/finalcholestrol.png">
            <input type="radio" name="radio" value=""  style="color: red" /><a href="heartattack_diabities.jsp?id=0"> HIGH LDL </a> </br>
            <input  type="radio" name="radio" value="" style="color: green" /><a href="heartattack_diabities.jsp?id=1"> LOW HDL </a>
          </div>
      <div class="container">
