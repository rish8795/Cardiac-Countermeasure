<%-- 
    Document   : lab_mytest
    Created on : 21 Apr, 2016, 4:22:23 PM
    Author     : Dell
--%>
...
<html lang="en">
    ...
    <body>    
        ...
        <section id="blogArchive">      
            ...
            <table class="table table-hover" style="width: 92%;margin-left: 30px">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Test's Name</th>
                ...
                <tbody>
                    <% if (request.getAttribute("ltest") != null) {

                            ArrayList<Labtest> ltest = (ArrayList<Labtest>) request.getAttribute("ltest");
                            int loop=1;
                            for (Labtest l : ltest) {
                    %>
                    <tr>
                        <th style="width: 5%" scope="row"><%= loop%></th>
                        <td style="width: 13%"><%=l.getTId().getTestName()%></td>
                        <td style="width: 55%"><%=l.getTId().getTestDescription()%></td>
                        <td style="width: 25%">
                            <form action="lab_mytest" >
                                <input type="number" name="price" required value="<%=l.getTestFees()%>"  style="height: 30px;margin: 5px;" />
                                <input type="hidden" name="ltid" value="<%=l.getLtId() %>" />
            ...
            <button class="wpcf7-submit button--itzel" type="submit" style="margin-left: 528px;"><i class="button__icon fa fa-plus"></i><span>Add More</span></button>                
