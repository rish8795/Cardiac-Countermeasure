        ...
        <section id="blogArchive">      
            ...
            <div stylr="width:1463px; height:1000px">
                <form method="post" class="submitphoto_form" action="patreg" style="margin-left: 420px;margin-top: 20px;margin-right: 60px;width: 890px; height: 1000px">
                    ...
                    <span class="my_profile"> Address:</span>  
                    <textarea class="my_profile_form" style="margin-left: -119px"required="required" aria-required="true" rows="8" cols="45" name="comment"></textarea></p>
                    <span class="my_profile" style="margin-right: 100px;">Tests:</span>
                    <ul class="footer-service" style="margin-left: 214px;width: 45%">
                        <li><a href="#"><span class="fa fa-check"></span>Test 1</a></li>
                        <li><a href="#"><span class="fa fa-check"></span>Test 2</a></li>
                        <li><a href="#"><span class="fa fa-check"></span>Test 3</a></li>

                    </ul>
                    <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-check"></i><span>Approve</span></button>
                    <button class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-remove"></i><span>Reject</span></button>
                </form>
            </div> 
