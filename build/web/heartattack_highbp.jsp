  ...
  <body>    
    ...
    color: initial;
     margin-top: -100px;">
            ...
            <p style="color: darkorange;">Are you suffering from high/Low Blood pressure problem?</p>
            <img class="img-center" src="images/bp.jpg">
            <input type="radio"  name="radio" value=""  style="color: red" /><a href="heartattack_age.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" />  <a href="heartattack_age.jsp?id=2"> NO </a>
          </div>
      <div class="container">
        <%
