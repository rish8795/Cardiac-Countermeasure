<%-- 
    ...
    Created on : 8 Mar, 2016, 1:37:01 AM
    Author     : rishabh
--%>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>CARDIAC COUNTERMEASURE :Redirecting</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->              
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="#"><i class="fa fa-heartbeat"></i><span style="font-family: cursive;">CARDIAC COUNTERMEASURE</span></a>              
              <!-- IMG BASED LOGO  -->
            ...
            <div class="meetDoctors-area">
             <!-- Start Service Title -->
              <div class="section-heading">
                  <h2 style="font-family: cursive;">Your Password has been sent to your registered Email id.. WAIT WHILE YOU ARE DIRECTED TO LOGIN PAGE.... If you are not redirected click the below button</h2><br/>
                  <button onclick="JavaScript:timedRedirect()">Click here</button>
                <div class="line"></div>
              </div>
