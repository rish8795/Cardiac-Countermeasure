            ...
            <div class="container">
              <div class="patient_profile">
                ...
                <% }%></span>
                        ...
                        <form method="get" class="submitphoto_form" action="changepassword_lab"  style="margin-left: 420px;margin-top: 20px;margin-right: 60px;width: 890px; height: 1000px" onsubmit="return myFunction()">
