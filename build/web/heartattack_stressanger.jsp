  ...
  <body>    
    ...
    color: initial;
     margin-top: -100px;">
            ...
            <p style="color: darkorange;">Are you suffering from Stress or very Angry person?</p>
            <img class="img-center" src="images/stress.jpg">
            <input type="radio"  name="radio" value=""  style="color: red" /><a href="heartattack_highbp.jsp?id=1">Stress</a><br>
            <input type="radio" name="radio" value="" style="color: green" />  <a href="heartattack_highbp.jsp?id=2"> Anger </a>
          </div>
      <div class="container">
        <%
