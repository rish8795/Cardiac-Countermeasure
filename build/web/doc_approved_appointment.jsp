...
<html lang="en">
    <head>
        ...
        <title>Cardiac Countermeasure:Cardiac approved Appointment</title>
            ...
            <div class="menu_area">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                      <li><a href="get_appointment_doc">List of Appointment</a></li>
                      <li  class="active"><a href="doc_view_approved_appointment">Approved Appointment</a></li>
                 </ul>
                </li>
