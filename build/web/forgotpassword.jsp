              ...
              <div class="patient_profile">
                <h2>Forgot Password</h2>
                        ...
                        <div stylr="width:1463px; height:1000px">
                            <span style="color: red;margin-left: 667px;">
                         <% if (request.getAttribute("msg") != null) {%>
                         <%=request.getAttribute("msg")%>
                         <% }%></span>
                        <form method="get" class="submitphoto_form" action="forgotpassword" style="margin-left: 420px;margin-top: 20px;margin-right: 60px;width: 890px; height: 1000px">
                            <span class="my_profile">Enter your id:</span> <input type="text" class="my_profile_form" placeholder="" value="" name="mail" style="margin-left: -155px;"></br>
<!--                        <span class="my_profile">Enter New Password:</span> <input type="text" class="my_profile_form" placeholder="" value="" name="p_lastname" style="margin-left: -151px;"></br>
                            <span class="my_profile">Enter New Password again:</span> <input type="text" class="my_profile_form" placeholder="" value="" name="gender" style="margin-left: -114px;"></br>
                                           -->
                            <button name="btn_update" value="Send" class="wpcf7-submit button--itzel" type="submit"><i class="button__icon fa fa-envelope"></i><span>Send Password</span></button>
                        </form>
                        </div>
