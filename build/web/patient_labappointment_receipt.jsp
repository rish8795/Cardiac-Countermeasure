<%-- 
    Document   : patient_labappointment_receipt
    Created on : 23 Apr, 2016, 5:01:42 PM
    Author     : Dell
--%>
...
<html lang="en">
    <head>
        ...
        <title>Cardiac Countermeasure:Laboratory Receipt</title>
    ...
    <body>    
        ...
        <section id="blogArchive">      
            ...
            <div class="">
                    ...
                    <button class="wpcf7-submit button--itzel" type="submit" style="margin-left: 528px;"><i class="button__icon fa fa-print"></i><span>Print Receipt</span></button>                
