            ...
            <div class="container">
              <div class="patient_profile">
                ...
                <% }%></span>
                 ...
                 <span style="color: red; font-size: larger; margin-left: 4px;">
                <% if (request.getAttribute("msg1") != null) {%>
                <%=request.getAttribute("msg1")%>
                <% }%></span>
                
                        <form method="get" class="submitphoto_form" action="changepassword_doc"  style="margin-left: 420px;margin-top: 20px;margin-right: 60px;width: 890px; height: 1000px" onsubmit="return myFunction()">
