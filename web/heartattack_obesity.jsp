  ...
  <body>    
    ...
    color: initial;
     margin-top: -100px;">
            ...
            <p style="color: darkorange;">Are you suffering from obesity?</p>
            <img class="img-center" src="images/obesity.jpg">
            <input type="radio"  name="radio" value=""  style="color: red" /><a href="heartattack_stressanger.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" />  <a href="heartattack_highbp.jsp?id=0"> NO </a>
          </div>
      <div class="container">
        <%
