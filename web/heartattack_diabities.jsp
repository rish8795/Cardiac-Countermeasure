...
<html lang="en">
  ...
  <body>    
    ...
    margin-top: -100px;">
            ...
            <p style="color: darkorange;">Do you have Diabeties?</p>
            <img class="img-center" src="images/diabities.jpg">
            <input type="radio" name="radio" value=""  style="color: red" /> <a href="heartattack_obesity.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" /> <a href="heartattack_obesity.jsp?id=1">No</a>
          </div>
      <div class="container">
        <%
