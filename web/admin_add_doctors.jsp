...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Cardiac Countermeasure:Add doctors</title>
            ...
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                ...
                <% }%>
                    ...
                    <%        ArrayList<Doctor> dp = (ArrayList<Doctor>) request.getAttribute("da");
                            int loop = 1;
                            for (Doctor dp1 : dp) {
                    ...
                    %> 
                                  <tr>
                                    ...
                                    <td> Dr.<%=dp1.getDFirstname() + " " + dp1.getDLastname() %></td>
                                    <td><a href="view_docprofile_admin?did=<%= dp1.getDId() %>" class="author-morepost">View Profile</a></td>
                           <td>
                            <form  action="admin_add_doctors">
                                <input type="hidden" name="dId" value="<%=dp1.getDId() %>" />
                    ...
                    <tr>
                        <td colspan="5"><h3 style="color: #FF9800">No more Request.!</h3></td>
                    </tr>
                    <% }%>
