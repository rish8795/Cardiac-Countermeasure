...
<html lang="en">
  ...
  <body>    
    ...
    margin-top: -100px;">
            ...
            <p style="color: darkorange;">Do your father had heart-attack before age of 50?</p>
            <img class="img-center" src="images/fatherage.jpg">
            <input type="radio" name="radio" value=""  style="color: red" /> <a href="heartattack_age1.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" /> <a href="heartattack_age1.jsp?id=1">No</a>
          </div>
      <div class="container">
        <%
