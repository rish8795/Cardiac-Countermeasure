...
<html lang="en">
  ...
  <body>    
    ...
    margin-top: -100px;">
            ...
            <p style="color: darkorange;">Do your Mother had heart-attack before age of 60?</p>
            <img class="img-center" src="images/motherage.jpg">
            <input type="radio" name="radio" value=""  style="color: red" /> <a href="heartattack_chestpain.jsp?id=0">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" /> <a href="heartattack_chestpain.jsp?id=1">No</a>
          </div>
      <div class="container">
        <%
