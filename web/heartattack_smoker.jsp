  ...
  <body>    
    ...
    color: initial;
     margin-top: -100px;">
            ...
            <p style="color: darkorange;">Are you Smoker?</p>
            <img class="img-center" src="images/cig.jpg">
            <input type="radio"  name="radio" value=""  style="color: red" /><a href="heartattack_cholestrol.jsp">Yes</a><br>
            <input type="radio" name="radio" value="" style="color: green" />  <a href="heartattack_diabities.jsp?id=2"> NO </a>
          </div>
      <div class="container">
