              ...
              <div class="patient_profile">
                <h2>My Profile</h2>
                        ...
                        <form method="post" class="submitphoto_form" action="patreg" style="margin-left: 420px;margin-top: 20px;margin-right: 60px;width: 890px; height: 1000px">
                            ...
                            <span class="my_profile">City:</span> <input type="text" class="my_profile_form" placeholder="" name="p_name" style="margin-left: -155px;"></br>
                            <span class="my_profile">Pincode:</span> <input type="text" class="my_profile_form" placeholder="" name="p_name" style="margin-left: -155px;"></br>
                            <span class="my_profile">Speciality:</span> <input type="text" class="my_profile_form" placeholder="" name="p_name" style="margin-left: -155px;"></br>
                            <span class="my_profile">Degree:</span> <input type="text" class="my_profile_form" placeholder="" name="p_name" style="margin-left: -155px;"></br>
